...
const (
	...
	// score of every date scored, taking the channel name. One row per date.
	featureInteropTrendlineURLFormat = "https://raw.githubusercontent.com/web-platform-tests/results-analysis/gh-pages/data/%s-browser-feature-interop.csv"
	...
	featureInteropBreakdownURLFormat = "https://raw.githubusercontent.com/web-platform-tests/results-analysis/gh-pages/data/%s-browser-feature-interop-%s.csv"
)
...
// [[sha,date,manifest,chrome-version,chrome,firefox-version,firefox,safari-version,safari,interop],
// [25f5e56ff8faa3aa9c65d1e0ed5b64ee7d4c0a11,2026-02-21,merge_pr_54321,145.0.7632.77,87.4,147.0.4,74.5,26.3,71.9,65.7],
// ...]
...
// channel, in chronological order, then the breakdown of its newest date.
