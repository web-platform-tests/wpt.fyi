# [web-platform-tests dashboard](https://wpt.fyi/) 📈 [![Build Status](https://travis-ci.com/web-platform-tests/wpt.fyi.svg?branch=master)](https://travis-ci.com/web-platform-tests/wpt.fyi) [![Python Updates](https://pyup.io/repos/github/web-platform-tests/wpt.fyi/shield.svg)](https://pyup.io/repos/github/web-platform-tests/wpt.fyi/)
