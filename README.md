...
![GitHub Actions](https://github.com/web-platform-tests/wpt.fyi/workflows/Continuous%20Integration/badge.svg) [![Travis Status](https://travis-ci.com/web-platform-tests/wpt.fyi.svg)](https://travis-ci.com/web-platform-tests/wpt.fyi) [![Python Updates](https://pyup.io/repos/github/web-platform-tests/wpt.fyi/shield.svg)](https://pyup.io/repos/github/web-platform-tests/wpt.fyi/)
