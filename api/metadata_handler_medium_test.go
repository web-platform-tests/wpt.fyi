...
func TestFilterMetadataHanlder_Success(t *testing.T) {
	...
	assert.Equal(t, `[{"test":"/randomfolder1/innerfolder1/innerfolder2/innerfolder3/foo1.html","subtest":"foo1-subtest","urls":["bugs.bar?id=456",""],"status":["FAIL",""]},{"test":"/randomfolder2/foo.html","urls":["","safari.foo.com"],"status":["","UNKNOWN"]},{"test":"/randomfolder3/innerfolder1/random3foo.html","urls":["bugs.bar",""],"status":["FAIL",""]}]`, res)
}
...
func TestFilterMetadataHandlerPost_Success(t *testing.T) {
	...
	assert.Equal(t, `[{"test":"/randomfolder1/innerfolder1/innerfolder2/innerfolder3/foo1.html","subtest":"foo1-subtest","urls":["bugs.bar?id=456",""],"status":["FAIL",""]},{"test":"/randomfolder3/innerfolder1/random3foo.html","urls":["bugs.bar",""],"status":["FAIL",""]}]`, res)
}
