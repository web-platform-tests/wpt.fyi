...
func TestFilterMetadataHanlder_Success(t *testing.T) {
	...
	assert.Equal(t, `[{"test":"/randomfolder1/innerfolder1/innerfolder2/innerfolder3/foo1.html","subtest":"foo1-subtest","urls":["bugs.bar?id=456",""],"status":[6,0]},{"test":"/randomfolder2/foo.html","urls":["","safari.foo.com"],"status":[0,0]},{"test":"/randomfolder3/innerfolder1/random3foo.html","urls":["bugs.bar",""],"status":[6,0]}]`, res)
}
...
func TestFilterMetadataHandlerPost_Success(t *testing.T) {
	...
	assert.Equal(t, `[{"test":"/randomfolder1/innerfolder1/innerfolder2/innerfolder3/foo1.html","subtest":"foo1-subtest","urls":["bugs.bar?id=456",""],"status":[6,0]},{"test":"/randomfolder3/innerfolder1/random3foo.html","urls":["bugs.bar",""],"status":[6,0]}]`, res)
}
