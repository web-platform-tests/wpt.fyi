...
func (m *MockAPI) ScheduleResultsNotifications(arg0 *shared.TestRun) error {
	m.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) ScheduleResultsNotifications(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ScheduleResultsNotifications", reflect.TypeOf((*MockAPI)(nil).ScheduleResultsNotifications), arg0)
}
