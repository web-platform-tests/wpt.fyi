...
// scheduleResultsNotifications mocks base method
func (m *MockAppEngineAPI) scheduleResultsNotifications(arg0 *shared.TestRun) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "scheduleResultsNotifications", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// scheduleResultsNotifications indicates an expected call of scheduleResultsNotifications
func (mr *MockAppEngineAPIMockRecorder) scheduleResultsNotifications(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "scheduleResultsNotifications", reflect.TypeOf((*MockAppEngineAPI)(nil).scheduleResultsNotifications), arg0)
}
