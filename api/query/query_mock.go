...
func (m *MocksharedInterface) LoadTestRunsByIDs(ctx context.Context, ids []int64) ([]shared.TestRun, error) {
	ret := m.ctrl.Call(m, "LoadTestRunsByIDs", ctx, ids)
	ret0, _ := ret[0].([]shared.TestRun)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MocksharedInterfaceMockRecorder) LoadTestRunsByIDs(ctx, ids interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadTestRunsByIDs", reflect.TypeOf((*MocksharedInterface)(nil).LoadTestRunsByIDs), ctx, ids)
}
