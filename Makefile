...
go_lint: go_deps golint_deps go_test_tag_lint
	...
	golint -set_exit_status $(WPTD_GO_PATH)/evisions/...
	golint -set_exit_status $(WPTD_GO_PATH)/hared/...
	golint -set_exit_status $(WPTD_GO_PATH)/til/...
	golint -set_exit_status $(WPTD_GO_PATH)/ebapp/...
	golint -set_exit_status $(WPTD_GO_PATH)/ebdriver/...
