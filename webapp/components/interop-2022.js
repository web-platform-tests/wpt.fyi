...
const FEATURES = {
  'interop-2021-aspect-ratio': {
    ...
    tests: '/results/?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2021-aspect-ratio',
  },
  'interop-2021-flexbox': {
    ...
    tests: '/results/css/css-flexbox?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2021-flexbox',
  },
  'interop-2021-grid': {
    description: 'Grid',
    mdn: 'https://developer.mozilla.org/docs/Web/CSS/grid',
    spec: 'https://drafts.csswg.org/css-grid-1/',
    tests: '/results/css/css-grid?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2021-grid',
  },
  'interop-2021-position-sticky': {
    ...
    tests: '/results/css/css-position/sticky?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2021-position-sticky',
  },
  'interop-2021-transforms': {
    ...
    tests: '/results/css/css-transforms?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2021-transforms',
  },
  'interop-2022-cascade': {
    ...
    tests: '/results/css/css-cascade?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-cascade',
  },
  'interop-2022-color': {
    ...
    tests: '/results/css/css-color?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-color',
  },
  'interop-2022-contain': {
    description: 'Containment',
    mdn: 'https://developer.mozilla.org/docs/Web/CSS/contain',
    spec: 'https://drafts.csswg.org/css-contain/#contain-property',
    tests: '/results/css/css-contain?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-contain',
  },
  'interop-2022-dialog': {
    description: 'Dialog Element',
    mdn: 'https://developer.mozilla.org/docs/Web/HTML/Element/dialog',
    spec: 'https://html.spec.whatwg.org/multipage/interactive-elements.html#the-dialog-element',
    tests: '/results/?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-dialog',
  },
  'interop-2022-forms': {
    description: 'Forms',
    ...
    tests: '/results/?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-forms',
  },
  'interop-2022-scrolling': {
    description: 'Scrolling',
    mdn: 'https://developer.mozilla.org/docs/Web/CSS/overflow',
    spec: 'https://drafts.csswg.org/css-overflow/#propdef-overflow',
    tests: '/results/css?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-scrolling',
  },
  'interop-2022-subgrid': {
    description: 'Subgrid',
    mdn: 'https://developer.mozilla.org/docs/Web/CSS/CSS_Grid_Layout/Subgrid',
    spec: 'https://drafts.csswg.org/css-grid-2/#subgrids',
    tests: '/results/css/css-grid/subgrid?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-subgrid',
  },
  'interop-2022-text': {
    description: 'Typography and Encodings',
    mdn: '',
    spec: '',
    tests: '/results/?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-text',
  },
  'interop-2022-viewport': {
    description: 'Viewport Units',
    mdn: '',
    spec: 'https://drafts.csswg.org/css-values/#viewport-relative-units',
    tests: '/results/css/css-values?label=master&label=experimental&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-viewport',
  },
  'interop-2022-webcompat': {
    description: 'Web Compat',
    mdn: '',
    spec: '',
    tests: '/results/?label=experimental&label=master&product=chrome&product=firefox&product=safari&aligned&view=percent&q=label%3Ainterop-2022-webcompat',
  },
};
